...
class Vector3 {
  ...
  add(other) {
    ...
    this.elements = [
      els[0] + other.elements[0],
      els[1] + other.elements[1],
      els[2] + other.elements[2],
    ];
  ...
  div(scalar) {
    ...
    let els = this.elements;
    this.elements = [els[0] / scalar, els[1] / scalar, els[2] / scalar];
  ...
  magnitude() {
    ...
    let els = this.elements;
    m = Math.sqrt(
      Math.pow(els[0], 2) + Math.pow(els[1], 2) + Math.pow(els[2], 2)
    );
  ...
  normalize() {
    ...
    let els = this.elements;
    this.elements = [els[0] / m, els[1] / m, els[2] / m];
